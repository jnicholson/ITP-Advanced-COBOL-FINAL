      ...
      * LAST EDIT    : 3/26/14                                          *
      * PURPOSE      : SCREENS FOR VISA MERCHANT PAGES INCLUDED WITHIN  *
      *******************************************************************
       01  WS-TIME-LOG.
           03  WS-DATE.
               05  WS-YEAR             PIC X(4).
       ...
       01  SCREEN-TITLE.
           03 SCREEN-TITLE-LINE-ONE.
               05  LINE 01 COL 01  "VISA MERCHANT MENU".
      ...
      *----------------------------------------------------------------- 
       01  SCREEN-ISSUER-MENU.
           03  SCREEN-MENU-OPTIONS.
               05  LINE 13 COL 30  VALUE "1.  SEARCH MERCHANTS".
               05  LINE 15 COL 30  VALUE "2.  ADD MERCHANTS".
               05  LINE 17 COL 30  VALUE "3.  EDIT/DELETE MERCHANTS".
      ...
      *-----------------------------------------------------------------
       01  SCREEN-SEARCH-ISSUER.
           03  SCREEN-SEARCH-OPTIONS.
               05  LINE 3  COL 30 VALUE "1. SEARCH BY MERCHANT ID NUM".
               05  LINE 5  COL 30 VALUE "2. SEARCH BY MERCHANT NAME".
           ...
           03  SCREEN-SEARCH-NAME.                                      
               ...
               05  LINE 16 COL 30 VALUE "ENTER ISSUER LAST NAME".
      ...
      *-----------------------------------------------------------------
       01  SCREEN-EDITING.
           03  SCREEN-EDIT-ALL.
               05  LINE 03 COL 11 VALUE "MERCHANT VALUES".
               05  LINE 05 COL 15 VALUE "MERCHANT ID:".
               05  LINE 05 COL 25 PIC X(20) FROM  WS-MERCHANT-ID.
               05  LINE 05 COL 15 VALUE "FIRST NAME:".
               05  LINE 06 COL 25 PIC X(20) FROM WS-MERCHANT-FNAME. 
               05  LINE 07 COL 15 VALUE "LAST NAME:". 
               05  LINE 07 COL 25 PIC X(20) FROM WS-MERCHANT-LNAME. 
               05  LINE 08 COL 15 VALUE "STREET:".
               05  LINE 08 COL 25 PIC X(20) FROM WS-MERCHANT-STREET.
               05  LINE 09 COL 15 VALUE "CITY:".  
               05  LINE 09 COL 25 PIC X(20) FROM WS-MERCHANT-CITY.  
               05  LINE 10 COL 15 VALUE "STATE:". 
               05  LINE 10 COL 25 PIC X(2)  FROM WS-MERCHANT-STATE. 
               05  LINE 11 COL 15 VALUE "ZIP:". 
               05  LINE 11 COL 25 PIC 9(5)  FROM WS-MERCHANT-ZIP.   
               05  LINE 12 COL 15 VALUE "CREDIT CARD:".   
               05  LINE 12 COL 25 PIC X(19) FROM WS-MERCHANT-CC.    
               05  LINE 13 COL 15 VALUE "EMAIL:".  
               05  LINE 13 COL 25 PIC X(20) FROM WS-MERCHANT-EMAIL
