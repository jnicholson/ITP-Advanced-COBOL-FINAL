      *Skeleton COBOL Copybook - JARROD LEE - 4/7/2014
       ...
       01  CHECKSCREEN.
           ...
           03  CHECK.
               ...
               05  LINE 12 COL 45 PIC X(30)    FROM VFX-2-ORIG-CITY.
               05  LINE 13 COL 26 VALUE "State".
               05  LINE 13 COL 45 PIC X(2)     FROM VFX-2-ORIG-STATE.
               05  LINE 14 COL 26 VALUE "Zip".
               05  LINE 14 COL 45 PIC X(5)     FROM VFX-2-ORIG-ZIP.
               05  LINE 15 COL 26 VALUE "Phone".
               05  LINE 15 COL 45 PIC X(11)    FROM VFX-2-ORIG-PHONE.
               05  LINE 16 COL 26 VALUE "Email".
               05  LINE 16 COL 45 PIC X(30)    FROM VFX-2-ORIG-EMAIL.
               05  LINE 17 COL 26 VALUE "CC Number".
               05  LINE 17 COL 45 PIC X(16)    FROM VFX-2-ORIG-CC.
               05  LINE 19 COL 28 VALUE "Is this information correct?".
               05  LINE 21 COL 30 PIC X        TO VFX-2-CHECK AUTO.
       ...
       01  EDITSCREEN.
           ...
           03  E-ADDRESS.
               ...
               05  LINE 14 COL 01 VALUE "City".
               05  LINE 14 COL 07 PIC X(30)    FROM VFX-2-ORIG-CITY.
               05  LINE 14 COL 45 VALUE "City".
               05  LINE 14 COL 51 PIC X(30)    FROM VFX-2-ORIG-CITY.
               05  LINE 15 COL 01 VALUE "State".
               05  LINE 15 COL 35 PIC X(2)     FROM VFX-2-ORIG-STATE.
               05  LINE 15 COL 45 VALUE "State".
               05  LINE 15 COL 79 PIC X(2)     FROM VFX-2-ORIG-STATE.
               05  LINE 16 COL 01 VALUE "Zip".
               05  LINE 16 COL 32 PIC X(5)     FROM VFX-2-ORIG-ZIP.
           03  E-ZIP.
           ...
           03  E-EMAIL.
               ...
               05  LINE 19 COL 21 PIC X(16)    FROM VFX-2-ORIG-CC.
           03  E-CC.
               05  LINE 19 COL 45 VALUE "CC Number".
               05  LINE 19 COL 65 PIC X(16)    TO VFX-2-EDIT-CC.
           03  E-SEL.
               05  LINE 22 COL 23 PIC X        TO VFX-2-CHECK AUTO.
               05  LINE 22 COL 25 VALUE "Press 'S' to SAVE ".
               05  LINE 22 COL 43 VALUE "or 'R' to RETURN".
               05  LINE 23 COL 29 VALUE "(all other keys start over)".
